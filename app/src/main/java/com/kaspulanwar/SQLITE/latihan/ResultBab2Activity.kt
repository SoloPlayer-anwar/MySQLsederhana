...
import kotlinx.android.synthetic.main.activity_result_bab2.*

class ResultBab2Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        home.setOnClickListener {
            val intent = Intent(this@ResultBab2Activity,
        ...
        cobalagi!!.setOnClickListener(View.OnClickListener {
            val i = Intent(this@ResultBab2Activity, LatihanBab2Activity::class.java)
            startActivity(i)
            finish()
        })

        uas.setOnClickListener {
            showNotif1()
        }
...
//        mIntent.putExtras(bundle)
        ...
        builder.setContentIntent(pendingIntent)
            ...
            .setContentTitle("Selamat Latihan Bab2 Clear")
            .setContentText("Silahkan klik disini jika anda mau melanjutkan materi bab3!")
