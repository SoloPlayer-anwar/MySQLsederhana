...
import kotlinx.android.synthetic.main.activity_result_bab3.*

class ResultBab3Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        home.setOnClickListener {
            val intent = Intent(this@ResultBab3Activity,
        ...
        cobalagi!!.setOnClickListener(View.OnClickListener {
            val i = Intent(this@ResultBab3Activity, LatihanBab3Activity::class.java)
            startActivity(i)
            finish()
        })
...
//        mIntent.putExtras(bundle)
        ...
        builder.setContentIntent(pendingIntent)
            ...
            .setContentTitle("Selamat Latihan Bab3 Clear")
            .setContentText("Silahkan klik disini jika anda mau melanjutkan materi bab4!")
