...
class ResultActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        home.setOnClickListener {
            val intent = Intent(this@ResultActivity,
        ...
        cobalagi!!.setOnClickListener(View.OnClickListener {
            val i = Intent(this@ResultActivity, LatihanActivity::class.java)
            startActivity(i)
            finish()
        })
...
//        mIntent.putExtras(bundle)
        ...
        builder.setContentIntent(pendingIntent)
            ...
            .setContentTitle("Selamat Latihan Bab1 Clear")
            .setContentText("Silahkan klik disini jika anda mau melanjutkan materi bab2!")
