...
import kotlinx.android.synthetic.main.activity_result_bab6.*

class ResultBab6Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_result_bab6)

        home.setOnClickListener {
            val intent = Intent(this@ResultBab6Activity,
        ...
        cobalagi!!.setOnClickListener(View.OnClickListener {
            val i = Intent(this@ResultBab6Activity, LatihanBab6Activity::class.java)
            startActivity(i)
            finish()
        })
...
//        mIntent.putExtras(bundle)
        ...
        builder.setContentIntent(pendingIntent)
            ...
            .setContentText("Selamat Anda Telah Menyelesaikan Semua Latihan Keren!")
